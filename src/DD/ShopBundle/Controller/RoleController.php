...
use DD\ShopBundle\Entity\Role;
use DD\ShopBundle\Form\RoleType;
...
class RoleController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('DDShopBundle:Role:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DDShopBundle:Role')->find($id);
        ...
        return $this->render('DDShopBundle:Role:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('DDShopBundle:Role:edit.html.twig', array(
            'entity'      => $entity,
