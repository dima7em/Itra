...
use DD\ShopBundle\Form\UserType;
...
class UserController extends Controller
{
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DDShopBundle:User')->find($id);
        ...
        return $this->render('DDShopBundle:User:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('DDShopBundle:User:edit.html.twig', array(
            'entity'      => $entity,
